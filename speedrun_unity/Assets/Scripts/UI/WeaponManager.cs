...
public class WeaponManager : MonoBehaviour
{
    ...
    public async void SetWeaponLevel(int level)
    {
        ...
        ChangeWeaponLevelAccounts account = new()
        {
        ...
        TransactionInstruction Ix = SpeedrunAnchorProgram.ChangeWeaponLevel(account, (ulong)level, SolanaManager.Instance.programId);
        tx.Add(Ix);
    ...
    private void OnLevelChanged(PlayerAccount player)
    {
        ...
        FindObjectOfType<Player>().currentWeaponLevel = (int)player.WeaponLvl;
    }
}